...
class RecommendationAuditLogModel(Base):
    ...
    trigger_rule_id: Mapped[str] = mapped_column(String(128), index=True, nullable=False)
...
class RecommendationPublishedEventModel(Base):
    __tablename__ = "recommendation_published_events"
...
Index(
    ...
    RecommendationAuditLogModel.company_id,
    RecommendationAuditLogModel.period_ref,
)
Index(
    "ix_recommendation_published_company_period",
    RecommendationPublishedEventModel.company_id,
    RecommendationPublishedEventModel.period_ref,
)
